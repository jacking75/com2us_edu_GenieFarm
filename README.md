...
클라이언트 -> 서버 전송 데이터 : Player ID(하이브로부터 받은), 인증 데이터, 닉네임, 앱 버전 정보, 게임 데이터 버전 정보
...
클라이언트 -> 서버 전송 데이터 : Player ID(하이브로부터 받은), 인증 데이터, 앱 버전 정보, 게임 데이터 버전 정보
...
클라이언트 -> 서버 전송 데이터 : 유저 ID(로그인 시에 게임서버로부터 받은), 인증 토큰(로그인 시 게임서버가 발급해준), 앱 버전 정보, 게임 데이터 버전 정보
