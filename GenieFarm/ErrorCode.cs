public enum ErrorCode : UInt16
{
    ...
    AuctionService_GetAuctionListByPage_EmptyItemList,
    ...
    AuctionService_GetAUctionItemStatistic_InvalidItemCode,
    AuctionService_BidAuction_InvalidAuctionId,
    ...
    AuctionService_DecreaseUserMoney_NotEnoughMoney,
    AuctionService_DecreaseUserMoneyForAuctionPrice_Exception,
    AuctionService_IncreaseUserMoney_InvalidBidderId,
    AuctionService_ReturnBidPriceToBidder_Exception,
    AuctionService_UpdateAuctionItemBidInfo_Fail,
    AuctionService_RenewAuctionBid_Exception,
    AuctionService_BuyNowAuction_InvalidAuctionId,
    AuctionService_UpdateAuctionItemPurchased_Fail,
    AuctionService_TerminateAuctionSoldOut_Exception,
    AuctionService_IncreaseUserMoney_Fail,
    AuctionService_PayMoneyToSeller_Exception,
    AuctionService_InsertAuctionItemToUser_Fail,
    AuctionService_ProvideItemToUser_Exception,
    AuctionService_GetUserItem_InvalidItemId,
    AuctionService_DeleteUserItem_Fail,
    AuctionService_GetAndDeleteUserItem_Exception,
    AuctionService_RegisterUserItemToAuction_InvalidItemCode,
    AuctionService_RegisterUserItemToAuction_Fail,
    AuctionService_RegisterUserItemToAuction_Exception,
    AuctionService_CancleAuction_InvalidAuctionId,
    AuctionService_InsertUserItem_Fail,
    AuctionService_ReturnAuctionItemToUser_Exception,
